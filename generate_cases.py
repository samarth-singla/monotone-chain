...
def gen_case_explicit_duplicates(n=10000):
...
def gen_case_triangle_edge(n=10000):
...
def gen_case_uniform_random(n=10000):
...
def gen_case_collinear_vertical(n=10000):
...
def gen_case_collinear_horizontal(n=10000):
...
def gen_case_gaussian_blob(n=10000):
...
def gen_case_rectangle(n=10000):
...
if __name__ == "__main__":
    ...
    print("\n--- Generating Test Datasets for Convex Hull (N=10000) ---")
    
    # 1. Collinearity Tests
    gen_case_collinear_vertical(10000)
    gen_case_collinear_horizontal(10000)
    
    # 2. Performance and Distribution Tests (N=10000)
    gen_case_uniform_random(10000)
    gen_case_gaussian_blob(10000)
    gen_case_circle(10000)
    gen_case_rectangle(10000)
    
    # 3. Sorting and Duplicates Tests (N=10000)
    gen_case_sorted(10000)
    gen_case_explicit_duplicates(10000)
    
    # 4. Geometric Edge Cases (N=10000 and N=200)
    gen_case_triangle_edge(10000)
